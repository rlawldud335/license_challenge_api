...
export const getSaleBoardPurchaser = "SELECT b.boardId, u.nickname, u.profileImage, b.title, b.content, b.createDt, b.image, b.reportCnt, af.previewFile, af.allFile, af.fileId, af.price FROM board b left JOIN user u ON b.userId = u.userId right JOIN attached_file af ON b.boardId = af.boardId WHERE b.boardId = ?";
